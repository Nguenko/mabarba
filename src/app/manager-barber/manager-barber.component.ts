...
@Component({
  selector: 'manager-barber',
  templateUrl: './manager-barber.component.html',
  styleUrls: ['./manager-barber.component.scss']
})
export class ManagerBarberComponent implements OnInit {
