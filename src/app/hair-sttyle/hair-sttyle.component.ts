...
@Component({
  selector: 'hair-sttyle',
  templateUrl: './hair-sttyle.component.html',
  styleUrls: ['./hair-sttyle.component.scss']
})
export class HairSttyleComponent implements OnInit {
  ...
  openDialogSlow(enterAnimationDuration: string, exitAnimationDuration: string): void {
